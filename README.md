...
## I. Data processing <processing.cpp>
...
-   category appears in the most of object.
-   category_id 15276 appeared in 85467 object.
2. Which category has the largest appeared times ?
-   category_id 6 appeared 1899183 times.
3. Is there any idea how to represent/visualize the data sample for analysing ?
-   Visualize the data using pie charts of some of the largest data and rest

## II. Data analysing <processing.cpp>
...
-   Sort subfile.
-   merge subfile to output file.
-   Input: hash_catid_count.csv
-   Output (sorted by object_id): output.csv
